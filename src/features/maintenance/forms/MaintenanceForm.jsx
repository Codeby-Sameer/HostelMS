...
const MaintenanceForm = ({ editingItem, onClose }) => {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    console.log("Maintenance submitted:", values)
  ...
  const renderField = (field, setFieldValue, values) => {
    ...
    return (
      ...
      <Field name={field.name}>
        {({ field: formikField }) => (
          <Input type={field.type} {...formikField} />
        )}
      </Field>
  ...
  return (
    ...
    <Formik
      ...
      validationSchema={validationSchemas.maintenance}
      ...
      {({ isSubmitting, setFieldValue, values }) => (
        ...
        <Form className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {formTemplates.maintenance.map(field => (
