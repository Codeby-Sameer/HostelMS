          ...
          <div className="mt-5 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="text-xs bg-slate-900 text-white py-2 rounded-md"
              >
                Super Admin
              </button>
              ...
              <button
                ...
                className="text-xs bg-blue-600 text-white py-2 rounded-md"
              >
                Hostel Admin
              </button>
              ...
              <button
                ...
                className="text-xs bg-green-600 text-white py-2 rounded-md"
              >
                Tenant
              </button>
              ...
              <button
                ...
                className="text-xs bg-purple-600 text-white py-2 rounded-md"
              >
                Visitor
              </button>
